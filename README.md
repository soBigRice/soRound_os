...
当前仓库 `main` 的发布基线为 `v1.4`。主线开发请使用 `GeekTool-IDF/`；Arduino 工程主要用于
早期原型和硬件压力测试。
...
- 15 个内置 App：Wi-Fi、I2C、系统信息、天气、日历、倒计时、秒表、设置、OTA、
  音频可视化、水平仪、迷宫、流体、骰子和 BLE 数字孪生。
...
- React + Three.js Web 校准器，通过 Web Bluetooth 显示设备姿态与电量。
