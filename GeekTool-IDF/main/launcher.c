...
// 注册表
const app_t *const APPS[] = { &app_wifi, &app_i2c, &app_sys, &app_weather, &app_calendar, &app_countdown, &app_stopwatch, &app_settings, &app_audio, &app_level, &app_maze, &app_fluid, &app_twin, &app_about };
...
static const icon_fn_t ICON_FN[] = { ic_wifi, ic_scan, ic_chip, ic_sun, ic_calendar, ic_countdown, ic_stopwatch, ic_settings, ic_audio, ic_level, ic_maze, ic_fluid, ic_twin, ic_about };  // 顺序对齐 APPS[]
